 ...
 * @see https://v0.dev/t/gHw6ISi7J7W
 */
    ...
    <div className="grid md:grid-cols-2 items-start gap-4">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="border border-dashed border-gray-200 rounded-lg p-4 flex items-center space-x-4">
            ...
            <div className="grid grid-cols-1 gap-1 flex-1">
              <div className="grid grid-cols-1 gap-1">
                <h3 className="text-base font-medium leading-none truncate">Introduction_to_Biology.mp4</h3>
                <p className="text-sm leading-none text-gray-500">2.4 GB</p>
              </div>
            </div>
          ...
          <div className="border border-dashed border-gray-200 rounded-lg p-4 flex items-center space-x-4">
            ...
            <div className="grid grid-cols-1 gap-1 flex-1">
              <div className="grid grid-cols-1 gap-1">
                <h3 className="text-base font-medium leading-none truncate">History_Lecture_Part_1.mp4</h3>
                <p className="text-sm leading-none text-gray-500">1.8 GB</p>
              </div>
            </div>
            <Button size="sm">Play</Button>
          </div>
          <div className="border border-dashed border-gray-200 rounded-lg p-4 flex items-center space-x-4">
            ...
            <div className="grid grid-cols-1 gap-1 flex-1">
              <div className="grid grid-cols-1 gap-1">
                <h3 className="text-base font-medium leading-none truncate">Cooking_Show_Episode_5.mp4</h3>
                <p className="text-sm leading-none text-gray-500">1.2 GB</p>
              </div>
            </div>
            <Button size="sm">Play</Button>
          </div>
          <div className="border border-dashed border-gray-200 rounded-lg p-4 flex items-center space-x-4">
            ...
            <div className="grid grid-cols-1 gap-1 flex-1">
              <div className="grid grid-cols-1 gap-1">
                <h3 className="text-base font-medium leading-none truncate">Nature_Walk_Exploration.mp4</h3>
                <p className="text-sm leading-none text-gray-500">3.1 GB</p>
              </div>
            </div>
            <Button size="sm">Play</Button>
          </div>
